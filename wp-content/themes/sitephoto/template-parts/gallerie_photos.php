        ...
        <div class="photo-block">
            <?php if (has_post_thumbnail()) : ?>
                ...
                <div class="photo-overlay">
                    ...
                    <div class="fullscreen-icon lightbox-enabled" data-imgsrc="<?php echo esc_url(get_the_post_thumbnail_url(get_the_ID())); ?>" data-reference="<?php the_field('reference'); ?>" data-categorie="<?php echo strip_tags(get_the_term_list($post->ID, 'categorie')); ?>">
